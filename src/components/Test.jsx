        ...
        <div className='bg-[#06090e] min-h-screen'>
            <div className='max-w-[768px] px-3 mx-auto'>
                <div className='flex flex-row flex-wrap pt-7'>
                    ...
                    <div className={`${activeTab === "tab1" ? "bg-[#191a20] rounded-md " : ""} w-2/12 px-3 text-center my-a uto`}>
                        <h2 className={`${activeTab === "tab1" ? "text-white " : "text-[#3e3e3e]"}  text-xl fw-normal capitalize pt-2 `}>mobile</h2>
                        <div className='flex justify-center pt-5 '>
                            <svg width="18" height="13" viewBox="0 0 18 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M6.993 12.421L0.285995 5.58L1.714 4.18L7.007 9.579L16.293 0.292999L17.707 1.707L6.993 12.421Z" fill="#3e3e3e" />
                            </svg>
                        </div>
                    ...
                    <div className={`${activeTab === "tab2" ? "bg-[#191a20] rounded-md " : ""} w-2/12 px-3 text-center my-a uto`}>
                    ...
                    <div className={`${activeTab === "tab3" ? "bg-[#191a20] rounded-md " : ""} w-2/12 px-3 text-center my-a uto`}>
